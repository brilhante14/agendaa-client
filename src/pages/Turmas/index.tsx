   ...
   return(
      <div className="turmas_container">
         ...
         <div className="turmas_searchBar">
            <img src={searchIcon} alt="Search Button" className="turmas_searchIcon" />
            <input 
               title="Buscar turmas"
               type="text"
               ...
               return(
                  <div className="turma_card" key={turma.id} >
                     <div className="turma_cardHeader">
                        ...
                        <span title={turma.professor}>{`Professor - ${turma.professor}`}</span>
                     </div>
         ...
         <Pagination totalPages={turmas.numberOfPages} currentPage={page} onPageChange={(newPage) => setPage(newPage)} />
      </div>
   )
}
